...
*
* Comments:
*/var h=(()=>{let t=!1,e=(s,i)=>{let r=document.createElement("link");r.rel=s,r.href=i,r.crossOrigin="true",document.head.append(r)};return s=>{t||s.noPreconnect||s.globalNoPreconnect||(e("preconnect","https://i.ytimg.com/"),e("preconnect","https://s.ytimg.com"),s.noCookie?e("preconnect","https://www.youtube-nocookie.com"):(e("preconnect","https://www.youtube.com"),e("preconnect","https://www.google.com"),e("preconnect","https://googleads.g.doubleclick.net"),e("preconnect","https://static.doubleclick.net")),t=!0)}})(),b=t=>{let{config:e}=t,{videoId:s}=t,i=t.videoTitle||e.textVideoTitle,r=t.description||e.textVideoDescription,o=t.noCookie?"-nocookie":"",n=t.playlistId?`?listType=playlist&list=${t.playlistId}`:`${s}`,a=document.createElement("script");a.id=`json-${s}`,a.type="application/ld+json",a.text=JSON.stringify({"@context":"https://schema.org","@type":"VideoObject",name:`${i}`,description:`${r}`,thumbnailUrl:`https://i.ytimg.com/vi/${s}/hqdefault.jpg`,contentUrl:`https://www.youtube.com/watch?v=${s}`,embedUrl:`https://www.youtube${o}.com/embed/${n}`}),t.prepend(a)},f=t=>{let{config:e}=t;return t.playText&&t.videoTitle?`${t.playText} ${t.videoTitle}`:t.playText?t.playText:t.videoTitle?`${e.textBtn} ${t.videoTitle}`:`${e.textBtn} ${e.textVideo}`};/**
* @preserve
...
*
* Comments:
*/(()=>{"use strict";let t=document.currentScript||document.getElementsByTagName("body")[0];class e extends HTMLElement{constructor(){super(),this.config=l(l({},m),window.embedYoutubeConfig||{}),this.scheduleUpdate,this.isIframeLoaded=!1,this.globalParam=t,g(this)}static get observedAttributes(){return["video-id","playlist-id","video-title","play-text","poster-url","poster-fallback","short"]}connectedCallback(){if(!this.videoId||this.videoId===""){this.domContainer.textContent="";let i=document.createElement("h2");return i.id="error-message",i.textContent=this.config.textMissingVideoId,this.domContainer.appendChild(i),!1}this.setupComponent(),this.addEventListener("click",()=>{this.loadIframe()}),this.addEventListener("pointerover",()=>{h(this)},{once:!0})}get globalAutoLoad(){return this.globalParam.hasAttribute("data-autoload")}get globalAutoPlay(){return this.globalParam.hasAttribute("data-autoplay")}get globalAutoPause(){return this.globalParam.hasAttribute("data-autopause")}get globalNoPreconnect(){return this.globalParam.hasAttribute("data-no-preconnect")}get globalNoSchema(){return this.globalParam.hasAttribute("data-no-schema")}get videoId(){return encodeURIComponent(this.getAttribute("video-id")||"")}get playlistId(){return encodeURIComponent(this.getAttribute("playlist-id")||"")}get videoTitle(){return this.getAttribute("video-title")||this.config.textVideoTitle}get description(){return this.getAttribute("description")}get playText(){return this.getAttribute("play-text")}get videoStartAt(){return this.getAttribute("video-start-at")||this.config.videoStartAt}get autoLoadMargin(){return this.getAttribute("autoload-margin")}get posterUrl(){return this.getAttribute("poster-url")}get posterQuality(){return this.getAttribute("poster-quality")||this.config.posterQuality}get paramList(){return this.getAttribute("param-list")}isYouTubeShort(){return this.getAttribute("short")===""&&window.matchMedia("(max-width: 40em)").matches}get autoLoad(){return this.hasAttribute("autoload")}get autoPlay(){return this.hasAttribute("autoplay")}get autoPause(){return this.hasAttribute("autopause")}get noCookie(){return this.hasAttribute("no-cookie")}get noLazyLoad(){return this.hasAttribute("no-lazyload")}get noSchema(){return this.hasAttribute("no-schema")}get noPreconnect(){return this.hasAttribute("no-preconnect")}get posterFallback(){return this.hasAttribute("poster-fallback")}setupComponent(){let i=f(this);this.domPlayButton.setAttribute("aria-label",i),this.setAttribute("title",i),this.domImgPoster.src="",this.domPlayButton.hidden=!1,this.posterFallback?this.setPosterFallback():this.posterUrl?this.setPosterCustom():this.setPoster(),(this.autoLoad||this.globalAutoLoad||this.isYouTubeShort())&&this.autoLoadIframe(),(this.autoPause||this.globalAutoPause)&&this.autoPauseVideo(),!this.noSchema&&!this.globalNoSchema&&b(this)}createIframe(){let i=this.noCookie?"-nocookie":"",r=this.playlistId?`?listType=playlist&list=${this.playlistId}&`:`${this.videoId}?`,o;if(this.paramList&&this.paramList!=="")o=this.paramList;else{let a=this.autoPlay||this.globalAutoPlay||this.autoPause||this.globalAutoPause||this.isYouTubeShort()?1:0,d=(this.autoPlay||this.globalAutoPlay)&&(this.autoLoad||this.globalAutoLoad)?1:0,y=d?1:0,v=this.videoStartAt;o=`enablejsapi=${a}&start=${v}`,d?o=`${o}&autoplay=${d}&mute=${y}`:o=`${o}&autoplay=1&mute=0`,this.isYouTubeShort()&&(o=`${o}&loop=1&modestbranding=1&playsinline=1&rel=0&playlist=${this.videoId}`)}return`<iframe title="${this.videoTitle}" credentialless allow="accelerometer;autoplay;encrypted-media;gyroscope;picture-in-picture" allowfullscreen src="https://www.youtube${i}.com/embed/${r}${o}"></iframe>`}loadIframe(){if(!this.isIframeLoaded){let i=this.createIframe();this.domContainer.insertAdjacentHTML("beforeend",i),this.domContainer.classList.add(this.config.activeIframeClass),this.isIframeLoaded=!0,this.dispatchEvent(new CustomEvent("embedYoutubeLoaded",{detail:{videoId:this.videoId,playlistId:this.playlistId,videoTitle:this.videoTitle,posterUrl:this.posterUrl},bubbles:!0,cancelable:!0}))}}autoLoadIframe(){let i={root:null,rootMargin:this.autoLoadMargin&&this.autoLoadMargin!==""?this.autoLoadMargin:"0px",threshold:0};new IntersectionObserver((o,n)=>{o.forEach(a=>{a.isIntersecting&&!this.isIframeLoaded&&(h(this),this.loadIframe(!0),n.unobserve(this))})},i).observe(this)}autoPauseVideo(){new IntersectionObserver(r=>{r.forEach(o=>{var n,a;o.isIntersecting||(a=(n=this.shadowRoot.querySelector("iframe"))==null?void 0:n.contentWindow)==null||a.postMessage('{"event":"command","func":"pauseVideo","args":""}',"*")})},{threshold:0}).observe(this)}setPosterFallback(){var o,n;let i=`<svg part="poster-fallback" xmlns="http://www.w3.org/2000/svg" viewBox="0 48 294 198" width="294" height="198"><path d="M294,48 c0-8.284-6.716-15-15-15H15 C6.716,33,0,39.716,0,48v198 c0,8.284,6.716,15,15,15h264 c8.284,0,15-6.716,15-15V48z" fill="red"/><path transform="translate(0,6)" d="M124,113.134 c0-2.68,1.596-5.155,3.917-6.495 c2.32-1.34,5.263-1.34,7.583,0 l37.046,21.364 c2.32,1.34,3.771,3.815,3.771,6.495 s-1.419,5.155-3.74,6.495 l-36.999,21.364 c-1.16,0.67-2.452,1.005-3.747,1.005 s-2.755-0.335-3.915-1.005 c-2.32-1.34-3.915-3.815-3.915-6.495V113.134z" fill="white"/><path transform="translate(0,-30)" d="M263.333,232H89v1 c0,4.143-3.357,7.5-7.5,7.5 S74,237.143,74,233v-1 H30.333 c-4.143,0-7.5-3.357-7.5-7.5 s3.357-7.5,7.5-7.5h44 c0-4.143,3.357-7.5,7.5-7.5 s7.5,3.357,7.5,7.5h174 c4.143,0,7.5,3.357,7.5,7.5 S267.476,232,263.333,232z" fill="white"/><text x="147" y="95" fill="white" font-family="Verdana, sans-serif" font-size="18" font-weight="bold" text-anchor="middle" alignment-baseline="middle">Play video</text></svg>`;(o=this.domPosterContainer.querySelector("#img-webp"))==null||o.remove(),(n=this.domPosterContainer.querySelector("#img-jpg"))==null||n.remove();let r=`data:image/svg+xml;charset=UTF-8,${encodeURIComponent(i)}`;this.domImgPoster.src=r,this.domImgPoster.removeAttribute("loading"),this.domImgPoster.setAttribute("alt",""),this.domPlayButton.hidden=!0,this.domPlayButton.setAttribute("aria-hidden","true")}setPosterCustom(){this.noLazyLoad&&this.domImgPoster.removeAttribute("loading"),this.domImgPoster.src=this.posterUrl,this.domImgPoster.onload=()=>{this.domImgPoster.src===this.posterUrl&&this.domImgPoster.setAttribute("alt",this.videoTitle)},this.domImgPoster.onerror=()=>{this.posterUrl&&this.setPosterFallback()}}setPoster(){let i=`https://i.ytimg.com/vi_webp/${this.videoId}/${this.posterQuality}.webp`,r=`https://i.ytimg.com/vi/${this.videoId}/${this.posterQuality}.jpg`;this.noLazyLoad&&this.domImgPoster.removeAttribute("loading");let o=new Image;o.fetchPriority="low",o.referrerPolicy="origin",o.src=i,o.onload=()=>{if(o.naturalWidth===120&&o.naturalHeight===90)return this.setPosterFallback();let a=document.createElement("source");a.id="img-webp",a.setAttribute("type","image/webp");let d=document.createElement("source");d.id="img-jpg",d.setAttribute("type","image/jpeg"),this.domPosterContainer.prepend(a,d),this.domPosterContainer.querySelector("#img-webp").srcset=i,this.domPosterContainer.querySelector("#img-jpg").srcset=r,this.domImgPoster.src=r}}attributeChangedCallback(i,r,o){if(r===null||r===o)return;this.scheduleUpdate&&cancelAnimationFrame(this.scheduleUpdate);let n=i==="video-id"?r:this.videoId;!this.noSchema&&!this.globalNoSchema&&this.querySelector(`#json-${n}`)&&this.querySelector(`#json-${n}`).remove(),this.scheduleUpdate=requestAnimationFrame(()=>{this.domContainer.classList.contains(this.config.activeIframeClass)&&(this.domContainer.classList.remove(this.config.activeIframeClass),this.shadowRoot.querySelector("iframe").remove(),this.isIframeLoaded=!1),this.setupComponent()})}}customElements.define("embed-youtube",e)})();})();

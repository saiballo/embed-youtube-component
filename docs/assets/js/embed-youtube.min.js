...
*
* Comments:
*/var p=()=>{let t=new CSSStyleSheet;return t.replaceSync(`
...
*
* Comments:
*/var g=t=>{let{config:e}=t;t.attachShadow({mode:"open"}),t.shadowRoot.adoptedStyleSheets=[p()],t.shadowRoot.innerHTML=`

		<div id="${e.idEmbedContainer}">
			<picture id="${e.idPosterContainer}">
				<img part="poster" id="${e.idPosterImg}" referrerpolicy="origin" loading="lazy" fetchpriority="low" alt="">
			</picture>
			<button id="${e.idBtnPlay}" part="play-button"></button>
		</div>
	`,t.domContainer=t.shadowRoot.getElementById(e.idEmbedContainer),t.domPosterContainer=t.shadowRoot.getElementById(e.idPosterContainer),t.domImgPoster=t.shadowRoot.getElementById(e.idPosterImg),t.domPlayButton=t.shadowRoot.getElementById(e.idBtnPlay)};/**
* @preserve
* Filename: util.js
*
